...
/datum/underbelly_shop/proc/_build_exclusive_pool()
	...
	if(prob(65))
		excl_master += list(list("The Abomination", "The work saiga of every Scum! Only you lot know how to use this...thing.", /obj/item/gun/ballistic/firearm/abomination, 3, 450, FALSE, "Scum"))
