@REM Script to easily upload Ratwood-2.0.rsc to your FTP-server so that clients download it from an
...
@REM Replace FOLDER/FOLDER with the folder on the FTP server where you want to store Ratwood-2.0.rsc, for example: cd www/rsc
@REM Replace FTP.DOMAIN.COM with the IP-address or domain name of your FTP server
@REM Add the URL to the location of Ratwood-2.0.rsc on your webserver into data\external_rsc_urls.txt
@REM
@echo off
...
echo put ..\..\Ratwood-2.0.rsc>> ftpcmd.dat
