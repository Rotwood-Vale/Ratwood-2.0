...
for (index, line) in enumerate(lines):
    if sorted_lines[index] != line:
        ...
        print(f"::error file=Ratwood-2.0.dme,line={index+offset},title=DME Validator::The include at line {index + offset} is out of order ({line}, expected {sorted_lines[index]})")
        sys.exit(1)
