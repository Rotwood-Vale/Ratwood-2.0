...
/obj/effect/spawner/lootdrop/roguetown/dungeon
	...
	loot = list(
		...
		/obj/item/weapon/greatsword/zwei = 1,
...
/obj/effect/spawner/lootdrop/roguetown/dungeon/tools
	...
	loot = list(
		...
		/obj/item/weapon/thresher = 3,
		/obj/item/flint = 4,
		/obj/item/weapon/stoneaxe/woodcut = 2,
		/obj/item/weapon/stoneaxe = 2,
		/obj/item/weapon/hammer/stone = 3,
		/obj/item/weapon/tongs = 3,
		/obj/item/weapon/pick = 3,
		/obj/item/weapon/sickle = 3,
		/obj/item/weapon/huntingknife = 2,
		/obj/item/weapon/huntingknife/scissors = 3,
		/obj/item/weapon/hoe = 3,
