/obj/effect/spawner/lootdrop/roguetown/sewers
	...
	loot = list(
		...
		/obj/item/weapon/mace/wsword = 6,
		/obj/item/weapon/huntingknife = 3,
		/obj/item/weapon/huntingknife/stoneknife = 6,
		...
		// tools
		/obj/item/weapon/shovel = 6,
		/obj/item/weapon/thresher = 6,
		/obj/item/flint = 8,
		/obj/item/weapon/stoneaxe/woodcut = 3,
		/obj/item/weapon/stoneaxe = 6,
		/obj/item/weapon/hammer/stone = 6,
		/obj/item/weapon/tongs = 6,
