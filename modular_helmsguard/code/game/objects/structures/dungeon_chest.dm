...
/obj/structure/closet/crate/chest/dungeon/generic_item/PopulateContents()
	...
	var/list/loot = list(
		...
		//weapons
		/obj/item/weapon/mace = 20,
		/obj/item/weapon/huntingknife/idagger/steel = 30,
		...
		/obj/item/weapon/mace/woodclub/crafted = 30,
		/obj/item/weapon/mace/cudgel = 20,
		/obj/item/weapon/mace/wsword = 30,
		/obj/item/weapon/huntingknife = 30,
		/obj/item/weapon/huntingknife/stoneknife = 30,
		/obj/item/weapon/halberd = 10,
		/obj/item/weapon/woodstaff = 30,
		/obj/item/weapon/spear = 10,

		// tools
		/obj/item/weapon/shovel = 30,
		/obj/item/weapon/thresher = 30,
		/obj/item/flint = 40,
		/obj/item/weapon/stoneaxe/woodcut = 30,
		/obj/item/weapon/stoneaxe = 30,
		/obj/item/weapon/hammer = 30,
		/obj/item/weapon/tongs = 30,
		/obj/item/weapon/pick = 30,
...
/obj/structure/closet/crate/chest/dungeon/weapon/PopulateContents()
	...
	var/list/loot = list(//sword
		/obj/item/weapon/sword/iron = 50,
		/obj/item/weapon/sword/iron/short = 50,
		/obj/item/weapon/sword/iron/messer = 30,
		/obj/item/weapon/sword/short/messer = 30,
		/obj/item/weapon/sword/falchion = 45,
		/obj/item/weapon/sword/sabre = 50,
		/obj/item/weapon/sword/falx = 35,
		/obj/item/weapon/sword/rapier = 35,
		/obj/item/weapon/sword/cutlass = 50,
		/obj/item/weapon/sword/gladius = 30,
		/obj/item/weapon/sword/silver = 30,
		/obj/item/weapon/sword/sabre/shamshir = 10,

	//axe
		/obj/item/weapon/stoneaxe/battle = 50,

	//blunt
		/obj/item/weapon/mace = 50,
		/obj/item/weapon/mace/cudgel = 30,
		/obj/item/weapon/mace/spiked = 25,

	//knives
		/obj/item/weapon/huntingknife = 35,
		/obj/item/weapon/huntingknife/idagger = 40,
		/obj/item/weapon/huntingknife/idagger/steel = 25,
		/obj/item/weapon/huntingknife/idagger/steel/parrying = 25,
		/obj/item/weapon/huntingknife/idagger/silver = 25,
		/obj/item/weapon/huntingknife/idagger/silver/elvish = 15,


	//polearms
		/obj/item/weapon/spear = 50,
		/obj/item/weapon/spear/billhook = 20,
		/obj/item/weapon/halberd = 10,
		/obj/item/weapon/halberd/bardiche = 10,
		/obj/item/weapon/eaglebeak = 10,
		/obj/item/weapon/eaglebeak/lucerne = 10,
		/obj/item/weapon/spear/bronze = 20,
...
/obj/structure/closet/crate/chest/reward/PopulateContents()
	...
	var/list/loot = list(
		...
		/obj/item/weapon/sword/long/judgement = 10,
		// /obj/item/weapon/sword/long/vlord = 10,		/obj/item/weapon/sword/long/marlin = 10,
		/obj/item/weapon/sword/long/exe = 10,
		/obj/item/weapon/sword/long/exe/cloth = 10,
		/obj/item/weapon/whip/antique = 10,
		/obj/item/weapon/mace/steel/morningstar = 15,
		/obj/item/weapon/mace/goden = 15,
		/obj/item/weapon/mace/goden/steel = 15,
		/obj/item/weapon/mace/stunmace = 10,
