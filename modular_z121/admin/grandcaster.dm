...
/client/proc/grandcaster()
	...
	set desc = "Grant a selected player 999 spell points, Learn Spell, base cantrip, and T4 arcane casting capability."
	...
	if(already_empowered)
		to_chat(src, span_notice("Refreshed GrandCaster on [target] and reset their available spell points to 999."))
		...
		message_admins(span_adminnotice("[key_name_admin(usr)] refreshed GrandCaster on [key_name_admin(target)], restoring T4 arcane access and resetting available spell points to 999."))
		admin_ticket_log(target, "<font color='green'>[key_name_admin(usr)] refreshed GrandCaster on you, restoring T4 arcane access and resetting your available spell points to 999.</font>")
	else
		to_chat(src, span_notice("Granted GrandCaster to [target]. They now have Learn Spell, 999 spell points, a base cantrip, and T4 arcane casting capability."))
		...
		message_admins(span_adminnotice("[key_name_admin(usr)] granted GrandCaster to [key_name_admin(target)], giving Learn Spell, 999 spell points, a base cantrip, and T4 arcane casting capability."))
		admin_ticket_log(target, "<font color='green'>[key_name_admin(usr)] has granted you GrandCaster, giving Learn Spell, 999 spell points, a base cantrip, and T4 arcane casting capability.</font>")
