		...
		if(force >= SEX_FORCE_EXTREME && prob(20))
			...
			if(chest && !chest.has_wound(/datum/wound/cbt))
				...
				if(has_cock && has_cunt)
					playsound(get_turf(target), pick('modular/sound/masomoans/agony/CBTScreamIntersex1.ogg', 'modular/sound/masomoans/agony/CBTScreamIntersex2.ogg'), 85, FALSE, 2, ignore_walls = FALSE)
					...
					playsound(get_turf(target), pick('modular/sound/masomoans/agony/CBTScreamMale1.ogg', 'modular/sound/masomoans/agony/CBTScreamMale2.ogg'), 85, FALSE, 2, ignore_walls = FALSE)
					target.add_splatter_floor(get_turf(target))
					...
					playsound(get_turf(target), pick('modular/sound/masomoans/agony/CBTScreamFemale1.ogg', 'modular/sound/masomoans/agony/CBTScreamFemale2.ogg'), 85, FALSE, 2, ignore_walls = FALSE)
					target.add_splatter_floor(get_turf(target))
