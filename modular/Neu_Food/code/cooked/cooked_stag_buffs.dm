// Stag essence and forest rush buffs - granted by consuming the White Stag's prime flesh.
...
// STAG PROTECTION - component applied when a player eats the full prime steak
