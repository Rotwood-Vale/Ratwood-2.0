...
/datum/virtue/combat/duelist
	...
	added_stashed_items = list("Duelist's Messer" = /obj/item/weapon/sword/short/messer/iron/virtue,
								"Duelist's Parrying Dagger" = /obj/item/weapon/huntingknife/idagger/virtue)
...
/datum/virtue/combat/executioner
	...
	added_stashed_items = list("Axe" = /obj/item/weapon/stoneaxe/woodcut,
...
/datum/virtue/combat/militia
	...
	added_stashed_items = list("Spear" = /obj/item/weapon/spear,
...
/datum/virtue/combat/brawler
	...
	added_stashed_items = list("Knuckles" = /obj/item/weapon/knuckles/bronzeknuckles,
								"More Knuckles" = /obj/item/weapon/knuckles/bronzeknuckles)
...
/datum/virtue/combat/shepherd
	...
	added_stashed_items = list("Iron Quarterstaff" = /obj/item/weapon/woodstaff/quarterstaff/iron,
