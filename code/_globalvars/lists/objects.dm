...
GLOBAL_LIST_EMPTY(important_items)			// Currently existing /obj/item instances marked as important.
GLOBAL_LIST_EMPTY(important_item_destroyed_log)	// Destroyed important items with last-known status text.
