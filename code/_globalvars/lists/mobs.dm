...
GLOBAL_LIST_EMPTY(mob_living_active_list)		//all non-dead /mob/living processed by SSmobs
GLOBAL_LIST_EMPTY(mob_living_dead_list)			//all dead /mob/living processed by SSmobs_dead
