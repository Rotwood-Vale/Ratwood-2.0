...
#define TRAIT_TRUE_CRITICAL_RESISTANCE "True Critical Resistance"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_TRUEUNSTOPPABLE = span_warning("I shrug off most nets, traps and shoves; only other giants can grab me."),
