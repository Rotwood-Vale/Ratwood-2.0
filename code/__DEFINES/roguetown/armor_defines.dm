...
#define ARMOR_PADDED_BAD list("blunt" = 50, "slash" = 30, "stab" = 20, "piercing" = 20, "fire" = 0, "acid" = 0)
#define ARMOR_PADDED list("blunt" = 70, "slash" = 40, "stab" = 30, "piercing" = 30, "fire" = 0, "acid" = 0)
#define ARMOR_PADDED_GOOD list("blunt" = 90, "slash" = 50, "stab" = 50, "piercing" = 50, "fire" = 0, "acid" = 0)
...
#define ARMOR_LEATHER_STUDDED list("blunt" = 80, "slash" = 80, "stab" = 60, "piercing" = 60, "fire" = 0, "acid" = 0) // Pseudo metallic armor therefore worse vs blunt
...
// Medium AC
#define ARMOR_CUIRASS list("blunt" = 40, "slash" = 100, "stab" = 80, "piercing" = 80, "fire" = 0, "acid" = 0)
...
#define ARMOR_PLATE_BAD list("blunt" = 10, "slash" = 50, "stab" = 50, "piercing" = 60, "fire" = 0, "acid" = 0) // For really bad / copper plate
#define ARMOR_PLATE list("blunt" = 10, "slash" = 100, "stab" = 80, "piercing" = 80, "fire" = 0, "acid" = 0)
#define ARMOR_PLATE_BSTEEL list("blunt" = 80, "slash" = 100, "stab" = 90, "piercing" = 85, "fire" = 0, "acid" = 0) // It's EVIL. OH GOD.
...
#define ARMOR_DRAGONSCALE list("blunt" = 100, "slash" = 100, "stab" = 100, "piercing" = 85, "fire" = 50, "acid" = 0)
