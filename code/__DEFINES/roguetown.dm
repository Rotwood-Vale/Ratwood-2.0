...
#define CTAG_SEDEENTCOMMANDER		"CAT_SEDEENTCOMMANDER"	// Militia Commander class -- handles weapon selection
#define CTAG_SEDEENTWATCHMAN		"CAT_SEDEENTWATCHMAN"	// Militia Watchman ckass -- handles weapon selection
