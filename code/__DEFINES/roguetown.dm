...
#define CTAG_UNDERBELLY		"CAT_UNDERBELLY"	// Underbelly criminal faction classes
#define CTAG_UNDERBELLY_GUTTERKING	"CAT_UNDERBELLY_GUTTERKING"
#define CTAG_UNDERBELLY_SCUM		"CAT_UNDERBELLY_SCUM"
#define CTAG_UNDERBELLY_FLESHTRADER	"CAT_UNDERBELLY_FLESHTRADER"
#define CTAG_UNDERBELLY_FLINGER	"CAT_UNDERBELLY_FLINGER"
#define CTAG_UNDERBELLY_RIPPER		"CAT_UNDERBELLY_RIPPER"
/*
...
// Social rank defines
#define SOCIAL_RANK_SCUM 1
#define SOCIAL_RANK_DIRT 2
#define SOCIAL_RANK_PEASANT 3
#define SOCIAL_RANK_YEOMAN 4
#define SOCIAL_RANK_MINOR_NOBLE 5
#define SOCIAL_RANK_NOBLE 6
