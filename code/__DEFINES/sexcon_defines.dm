...
#define SPURT_KNOTTED_BONUS 1
#define SPURT_HEMIPENIS_BONUS 1
...
#define SPURT_EXCESSIVE_MIN_TOTAL 3
#define SPURT_EXCESSIVE_STACON_STEP 2
#define SPURT_EXCESSIVE_BASE_BONUS 2
#define SEMEN_VOLUME_EXCESSIVE_MULTIPLIER 2
#define SEMEN_VOLUME_EXCESSIVE_MIN_TOTAL 6
#define LOAD_EXCESSIVE_MULTIPLIER 1.5
