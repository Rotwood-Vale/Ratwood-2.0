...
#define SPURT_EXCESSIVE_ADDITIONAL_BONUS 2
#define SPURT_EXCESSIVE_ADDITIONAL_MAX 7
#define SPURT_EXCESSIVE_VOLUME_BONUS 2
#define SEMEN_VOLUME_EXCESSIVE_MAX 16
