...
/datum/economic_region/kingsfield
	...
	demands = list(
		...
		TRADE_GOOD_SALMON = TG_DEMAND_FISH_RARE,
		...
		TRADE_GOOD_PLAICE = TG_DEMAND_FISH_RARE,
		TRADE_GOOD_ANGLER = TG_DEMAND_FISH_RARE,
		TRADE_GOOD_EEL = TG_DEMAND_FISH_SPECIALTY,
		TRADE_GOOD_OCTOPUS = 3,
		TRADE_GOOD_BLACK_SALMON = TG_DEMAND_FISH_SPECIALTY,
		TRADE_GOOD_FLOUNDER = TG_DEMAND_FISH_SPECIALTY,
		TRADE_GOOD_BLACK_BASS = TG_DEMAND_FISH_SPECIALTY,
		TRADE_GOOD_STURGEON = TG_DEMAND_FISH_RARE,
		TRADE_GOOD_MACKEREL = TG_DEMAND_FISH_RARE,
		TRADE_GOOD_BEAK_SNAPPER = TG_DEMAND_FISH_RARE,
	)
...
/datum/economic_region/saltwick
	...
	produces = list(
		...
		TRADE_GOOD_SALMON = TG_SUPPLY_FISH_RARE,
		...
		TRADE_GOOD_PLAICE = TG_SUPPLY_FISH_RARE,
		TRADE_GOOD_ANGLER = TG_SUPPLY_FISH_RARE,
		TRADE_GOOD_EEL = TG_DEMAND_FISH_SPECIALTY,
		TRADE_GOOD_OCTOPUS = 3,
		TRADE_GOOD_BLACK_SALMON = TG_DEMAND_FISH_SPECIALTY,
		TRADE_GOOD_FLOUNDER = TG_DEMAND_FISH_SPECIALTY,
		TRADE_GOOD_BLACK_BASS = TG_DEMAND_FISH_SPECIALTY,
		TRADE_GOOD_STURGEON = TG_SUPPLY_FISH_RARE,
		TRADE_GOOD_MACKEREL = TG_SUPPLY_FISH_RARE,
		TRADE_GOOD_BEAK_SNAPPER = TG_SUPPLY_FISH_RARE,
	)
	demands = list(
		TRADE_GOOD_SALT = TG_DEMAND_SALT,
		TRADE_GOOD_FIBERS = TG_DEMAND_CLOTH,
