...
/datum/advclass/ranesheni_emir
	...
	traits_applied = list(TRAIT_NOBLE, TRAIT_HEAVYARMOR, TRAIT_STEELHEARTED,TRAIT_MIASMARES)
...
/datum/advclass/ranesheni_amirah
	...
	traits_applied = list(TRAIT_NOBLE, TRAIT_SEEPRICES, TRAIT_NUTCRACKER, TRAIT_GOODLOVER,TRAIT_MIASMARES)
