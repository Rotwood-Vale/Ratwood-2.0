...
/datum/preferences/proc/SetChoices(mob/user, limit = 14, list/splitJobs = list("Court Magician", "Knight Captain", "Bishop", "Merchant", "Archivist", "Towner", "Grenzelhoft Mercenary", "Beggar", "Prisoner", "Goblin King", "Gutter King", "Vagabond", "Inquisitor"), widthPerColumn = 295, height = 620) //295 620
	if(!SSjob)
		return
