	...
	switch(mode)
		if(0)
			if(findtext(message, "secrets of the throat"))
				say("My commands are: Make Decree, Make Announcement, Set Taxes, Revise Charter, Declare Outlaw, Summon Crown, Summon Key, Set Laws, Make Law, Set Laws, Purge Laws, Purge Decrees, Become Regent, Change Colors, I Ascend, Nevermind")
