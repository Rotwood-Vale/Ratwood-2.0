...
/mob/living/simple_animal/hostile/retaliate/rogue/elemental/questbehemoth/Initialize()
	src.adjust_skillrank(/datum/skill/combat/unarmed, 4, TRUE)
	. = ..()

/mob/living/simple_animal/hostile/retaliate/rogue/elemental/questbehemoth/death(gibbed)
	..()
	update_icon()
	spill_embedded_objects()
	qdel(src)

/mob/living/simple_animal/hostile/retaliate/rogue/elemental/questbehemoth/AttackingTarget()
...
/mob/living/simple_animal/hostile/retaliate/rogue/elemental/questbehemoth/MoveToTarget(list/possible_targets)//Step 5, handle movement between us and our target
...
/obj/effect/proc_holder/spell/invoked/ele_quake/cast(list/targets, mob/living/user = usr)
	if(istype(user, /mob/living/simple_animal/hostile/retaliate/rogue/elemental/questbehemoth))
		var/mob/living/simple_animal/hostile/retaliate/rogue/elemental/questbehemoth/rockguy = user
...
/mob/living/simple_animal/hostile/retaliate/rogue/elemental/questbehemoth/proc/quake(atom/target)
	if(!target)
		return FALSE
...
/mob/living/simple_animal/hostile/retaliate/rogue/elemental/questbehemoth/proc/yeet(target)
