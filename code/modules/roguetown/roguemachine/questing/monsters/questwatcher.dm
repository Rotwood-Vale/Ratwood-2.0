...
/mob/living/simple_animal/hostile/retaliate/rogue/infernal/questwatcher/simple_add_wound(datum/wound/wound, silent = FALSE, crit_message = FALSE)	//no wounding the watcher
	return

/mob/living/simple_animal/hostile/retaliate/rogue/infernal/questwatcher/MeleeAction(patience = TRUE)
