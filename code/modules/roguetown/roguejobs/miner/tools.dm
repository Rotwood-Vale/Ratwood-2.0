...
/obj/item/rogueweapon/pick/ancient
	name = "ancient pick"
	desc = "A chisel of wrought gilbranze, which once labored to gather the ores necessary for an ancient alloy, and perhaps shall again."
	force = 21
	force_wielded = 28
	icon_state = "apick"
	max_integrity = 600
...
/obj/item/rogueweapon/pick/ancient/decrepit
	name = "decrepit pick"
