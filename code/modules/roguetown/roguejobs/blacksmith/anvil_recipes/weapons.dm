...
/datum/anvil_recipe/weapons/holysteel/EoraShoot
	name = "Eoran Harp-bow (+1 Fiber)"
	additional_items = list(/obj/item/natural/fibers)
	created_item = /obj/item/gun/ballistic/revolver/grenadelauncher/bow/longbow/eora
