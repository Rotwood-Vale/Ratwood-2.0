...
/mob/dead/observer/rogue/scadu/proc/ability_manifest(turf/T)
	...
	ADD_TRAIT(G, TRAIT_KNEESTINGER_IMMUNITY, "scadu_manifest")
	ADD_TRAIT(G, TRAIT_NOMOOD, "scadu_manifest")
	ADD_TRAIT(G, TRAIT_NOBREATH, "scadu_manifest")
	ADD_TRAIT(G, TRAIT_NOPAIN, "scadu_manifest")
	ADD_TRAIT(G, TRAIT_TOXIMMUNE, "scadu_manifest")
	ADD_TRAIT(G, TRAIT_LEECHIMMUNE, "scadu_manifest")
	ADD_TRAIT(G, TRAIT_EXTREME_TEMPERATURE_IMMUNE, "scadu_manifest")
	ADD_TRAIT(G, TRAIT_NOHUNGER, "scadu_manifest")
	ADD_TRAIT(G, TRAIT_LONGSTRIDER, "scadu_manifest")
	ADD_TRAIT(G, TRAIT_INFINITE_STAMINA, "scadu_manifest")
