...
/obj/item/weapon/spear/dreamscape_trident/throw_impact(atom/hit_atom, datum/thrownthing/throwingdatum)
	. = ..()
...
/obj/item/weapon/spear/dreamscape_trident/proc/create_shockwave(turf/epicenter, distance)
...
/obj/item/weapon/spear/dreamscape_trident/proc/revert_shockwave(turf/epicenter, list/visual_effects, max_radius)
	set waitfor = FALSE
...
/obj/item/weapon/spear/dreamscape_trident/proc/get_ring_turfs(turf/center, radius)
...
/obj/item/weapon/spear/dreamscape_trident/proc/affect_mob(mob/living/L, distance, radius, threshold)
	if(L.stat == DEAD)
		return
...
/obj/item/weapon/spear/dreamscape_trident/proc/knockup_effect(mob/living/L)
	// Animation
