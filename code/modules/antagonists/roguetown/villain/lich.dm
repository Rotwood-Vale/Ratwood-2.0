...
/datum/outfit/job/roguetown/lich/pre_equip(mob/living/carbon/human/H) //Equipment is located below
	...
	if(H.mind)
		...
		H.mind.AddSpell(new /datum/action/cooldown/spell/raise_undead)
		H.mind.AddSpell(new /datum/action/cooldown/spell/summon_lesser_undead)
		...
		H.mind.AddSpell(new /datum/action/cooldown/spell/suicidebomb)
