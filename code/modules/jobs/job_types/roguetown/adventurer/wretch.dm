...
/proc/wretch_select_bounty(mob/living/carbon/human/H)
	var/bounty_poster = input(H, "Who placed a bounty on you?", "Bounty Poster") as anything in list("The Justiciary of Ferentia", "The Grenzelhoftian Holy See", "The Otavan Orthodoxy")
