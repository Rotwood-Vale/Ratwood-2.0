...
/proc/update_wretch_slots()
	...
	//Add 1 slot for every 10 players over 60. Less than 60 players, 5 slots. 60 or more players, 6 slots. 80 or more players, 7 slots - etc.
	if(player_count > 60)
		var/extra = floor((player_count - 60) / 10)
		slots += extra
