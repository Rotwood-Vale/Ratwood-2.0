...
/datum/advclass/heartfelt/retinue/prior
	...
	traits_applied = list(TRAIT_CHOSEN, TRAIT_RITUALIST, TRAIT_SOUL_EXAMINE, TRAIT_GRAVEROBBER, TRAIT_RESONANCE, TRAIT_VOTARY, TRAIT_HOMESTEAD_EXPERT)
...
/datum/outfit/job/roguetown/heartfelt/prior/pre_equip(mob/living/carbon/human/H)
	...
	ADD_TRAIT(H, TRAIT_RESONANCE, TRAIT_GENERIC)
	ADD_TRAIT(H, TRAIT_VOTARY, TRAIT_GENERIC) 
