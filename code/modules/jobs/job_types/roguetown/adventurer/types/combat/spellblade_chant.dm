...
<h4>Abilities</h4>
<ul>
<li><b>Valean Phalanx</b> - 3-tile line thrust that pushes enemies back 1 tile. Empowered: doubles damage.</li>
<li><b>Valean Javelin</b> - Hurl an armor-piercing phantom spear that slows. No slowdown while charging.</li>
...
<p>There was once a great city. On the foot of this very mountain, over the Valian Sea.</p>
...
/proc/get_blade_chant_text(faction, mob/living/carbon/human/H)
	switch(faction)
		if("blackoak")
			return {"<p><em>I am a blade of Tarichea - The Vale, her name reborn!</em></p>
...
<p><b>WAKE UP. WAKE UP.</b></p>"}
	return {"<p><em>I am a blade of The Vale.</em></p>
...
<p><em>This body is-</em></p>
<p><b>WAKE UP. WAKE UP.</b></p>"}
	return {"<p><em>I am a shield of The Vale.</em></p>
...
/proc/get_macebearer_chant_text(faction, mob/living/carbon/human/H)
	switch(faction)
		if("blackoak")
			return {"<p><em>I am a mace of Tarichea - The Vale, her name reborn!</em></p>
...
<p><em>This body is-</em></p>
<p><b>WAKE UP. WAKE UP.</b></p>"}
	return {"<p><em>I am a mace of The Vale.</em></p>
