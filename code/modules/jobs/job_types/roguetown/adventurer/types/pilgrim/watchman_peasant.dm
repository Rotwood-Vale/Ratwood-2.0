...
/datum/outfit/job/roguetown/adventurer/levy/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		// Weapon selection
		var/weapons = list("Militia Spear","Militia Goedendag","Militia Falchion","Militia Warpick","Militia Steel Warpick","Militia War Axe","Silver Militia Shovelaxe","Militia Flail","Militia Knife")
