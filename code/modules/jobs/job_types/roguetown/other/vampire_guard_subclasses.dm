...
/datum/outfit/job/roguetown/other/vampguardsman/pre_equip(mob/living/carbon/human/H)
	...
	cloak = /obj/item/clothing/cloak/stabard/vamp
...
/datum/outfit/job/roguetown/other/vampskirmisher/pre_equip(mob/living/carbon/human/H)
	...
	cloak = /obj/item/clothing/cloak/stabard/vamp
	head = /obj/item/clothing/head/roguetown/helmet/leather/armorhood/advanced/vamp //Minimal face protection, maximal auramaxxing.
...
/datum/outfit/job/roguetown/other/vampduelist/pre_equip(mob/living/carbon/human/H)
	...
	cloak = cloak = /obj/item/clothing/cloak/half/vamp //They get to auramax, as a treat
	neck = /obj/item/clothing/neck/roguetown/chaincoif/ancient
...
/datum/advclass/vampbomber
	...
	traits_applied = list(TRAIT_STEELHEARTED, TRAIT_ALCHEMY_EXPERT, TRAIT_MEDIUMARMOR, TRAIT_CIVILIZEDBARBARIAN)
	category_tags = list(CTAG_VAMPGUARD)
	subclass_stats = list(
		STATKEY_INT = 2,
		STATKEY_WIL = 2,
...
/obj/item/clothing/cloak/stabard/vamp
...
/obj/item/clothing/head/roguetown/helmet/leather/armorhood/advanced/vamp
	color = CLOTHING_RED
