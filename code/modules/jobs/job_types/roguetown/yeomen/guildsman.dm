...
// But also includes a Artificer-Architect.
/datum/job/roguetown/guildsman
	...
	As a Guildsman, you hail from the three most important constituent guilds: The Smith's Guild, and the Architech's The Guildsmaster has sway over you, but it is not absolute."
