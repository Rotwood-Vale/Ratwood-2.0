...
/datum/advclass/vanguard/footman
	...
	subclass_stats = list(
		STATKEY_STR = 1,//Giving vanguard 2 STR would make them on par with Iconoclaust.
		STATKEY_CON = 1,
		STATKEY_WIL = 1,
		STATKEY_PER = 1,
		STATKEY_SPD = 1
	...
	subclass_skills = list(
		...
		/datum/skill/combat/wrestling = 3,//Do NOT give vanguard expert skills you MANIACS.
