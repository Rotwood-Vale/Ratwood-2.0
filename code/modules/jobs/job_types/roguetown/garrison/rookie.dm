/datum/job/roguetown/rookie
	...
	min_pq = -5 //rookies aren't great but they can do some damage
	max_pq = null
	...
	job_subclasses = list(
		/datum/advclass/rookie/lancer,
		/datum/advclass/rookie/footman,
		/datum/advclass/rookie/skirmisher
	)
