...
/datum/advclass/warden/ranger
	...
	subclass_stats = list(
		STATKEY_PER = 1,//They get plenty of stats from their buff.
		STATKEY_SPD = 1,
	)
...
/datum/advclass/warden/forester
	...
	subclass_stats = list(
		STATKEY_STR = 1,//They get plenty of stats from the buff, a militia of volunteers shouldn't be equivalent in stats to MAA (professional soldiers).
		STATKEY_PER = 1
	)
	subclass_skills = list(
