...
/datum/outfit/job/roguetown/psydoniantemplar/choose_loadout(mob/living/carbon/human/H)
	...
	switch(weapon_choice)
		...
		if("Psydonic War Axe + Shield")
			H.put_in_hands(new /obj/item/rogueweapon/stoneaxe/battle/silver/psy(H), TRUE)
			H.equip_to_slot_or_del(new /obj/item/rogueweapon/shield/tower/metal, SLOT_BACK_L, TRUE)
			H.adjust_skillrank_up_to(/datum/skill/combat/axes, 4, TRUE)
		if("Psydonic Whip + Shield")
			H.put_in_hands(new /obj/item/rogueweapon/whip/silver/psy(H), TRUE)
			H.equip_to_slot_or_del(new /obj/item/rogueweapon/shield/tower/metal, SLOT_BACK_L, TRUE)
		...
		if("Psydonic Grand Mace + Shortsword")
			...
			H.put_in_hands(new /obj/item/rogueweapon/sword/short/silver/psy(H), TRUE)
			H.equip_to_slot_or_del(new /obj/item/rogueweapon/scabbard/gwstrap, SLOT_BACK_L, TRUE)
			H.equip_to_slot_or_del(new /obj/item/rogueweapon/scabbard/sword, SLOT_BELT_L, TRUE)
			H.adjust_skillrank_up_to(/datum/skill/combat/maces, 4, TRUE)
		if("Psydonic Spear + Handmace")
			H.put_in_hands(new /obj/item/rogueweapon/spear/silver/psy(H), TRUE)
			H.put_in_hands(new /obj/item/rogueweapon/mace/cudgel/silver/psy(H), TRUE)
			H.equip_to_slot_or_del(new /obj/item/rogueweapon/scabbard/gwstrap, SLOT_BACK_L, TRUE)
			H.adjust_skillrank_up_to(/datum/skill/combat/polearms, 4, TRUE)
		if("Psydonic Poleaxe + Shortsword")
			H.put_in_hands(new /obj/item/rogueweapon/greataxe/silver/psy/(H), TRUE)
			H.put_in_hands(new /obj/item/rogueweapon/sword/short/silver/psy(H), TRUE)
			H.equip_to_slot_or_del(new /obj/item/rogueweapon/scabbard/gwstrap, SLOT_BACK_L, TRUE)
			H.equip_to_slot_or_del(new /obj/item/rogueweapon/scabbard/sword, SLOT_BELT_L, TRUE)
			H.adjust_skillrank_up_to(/datum/skill/combat/polearms, 4, TRUE)
		if("Psydonic Halberd + Shortsword")
			H.put_in_hands(new /obj/item/rogueweapon/halberd/silver/psy(H), TRUE)
			H.put_in_hands(new /obj/item/rogueweapon/sword/short/silver/psy(H), TRUE)
			H.equip_to_slot_or_del(new /obj/item/rogueweapon/scabbard/gwstrap, SLOT_BACK_L, TRUE)
			H.equip_to_slot_or_del(new /obj/item/rogueweapon/scabbard/sword, SLOT_BELT_L, TRUE)
			H.adjust_skillrank_up_to(/datum/skill/combat/polearms, 4, TRUE)
