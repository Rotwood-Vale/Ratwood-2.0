...
/datum/outfit/job/roguetown/puritan/ordinator/choose_loadout(mob/living/carbon/human/H)
	...
	switch(weapon_choice)
		if("Psydonic Broadsword + Dagger")
			H.put_in_hands(new /obj/item/weapon/sword/long/kriegmesser/psy/preblessed(H), TRUE)
			H.put_in_hands(new /obj/item/weapon/huntingknife/idagger/silver/psydagger(H), TRUE)
			H.equip_to_slot_or_del(new /obj/item/weapon/scabbard/sword, SLOT_BACK_R, TRUE)
			H.equip_to_slot_or_del(new /obj/item/weapon/scabbard/sheath, SLOT_BELT_L, TRUE)
			H.adjust_skillrank_up_to(/datum/skill/combat/swords, 5, TRUE)
			H.adjust_skillrank_up_to(/datum/skill/combat/knives, 4, TRUE)
		if("Psydonic Poleaxe + Dagger")
			H.put_in_hands(new /obj/item/weapon/greataxe/psy/preblessed(H), TRUE)
			H.put_in_hands(new /obj/item/weapon/huntingknife/idagger/silver/psydagger(H), TRUE)
		...
		if("Apocrypha (Greatsword) + Dagger")
			H.put_in_hands(new /obj/item/weapon/greatsword/psygsword/relic(H), TRUE)
			H.put_in_hands(new /obj/item/weapon/huntingknife/idagger/silver/psydagger(H), TRUE)
			H.equip_to_slot_or_del(new /obj/item/weapon/scabbard/gwstrap, SLOT_BACK_R, TRUE)
			H.equip_to_slot_or_del(new /obj/item/weapon/scabbard/sheath, SLOT_BELT_L, TRUE)
			H.adjust_skillrank_up_to(/datum/skill/combat/swords, 5, TRUE)
		...
		if("Covenant And Creed (Broadsword + Shield)")
			H.put_in_hands(new /obj/item/weapon/greatsword/bsword/psy/relic(H), TRUE)
			H.put_in_hands(new /obj/item/weapon/scabbard/gwstrap(H), TRUE)
			H.equip_to_slot_or_del(new /obj/item/weapon/shield/tower/metal/psy, SLOT_BACK_R, TRUE)
			H.adjust_skillrank_up_to(/datum/skill/combat/swords, 5, TRUE)
			H.adjust_skillrank_up_to(/datum/skill/combat/shields, 4, TRUE)
		if("Covenant and Consecratia (Flail + Shield)")
			H.put_in_hands(new /obj/item/weapon/flail/sflail/psyflail/relic(H), TRUE)
			H.equip_to_slot_or_del(new /obj/item/weapon/shield/tower/metal/psy, SLOT_BACK_R, TRUE)
