/datum/job/roguetown/puritan
	...
	tutorial = "You are a puritan of unmatched aptitude, adherent to the Psydonic doctrine and entrusted with the authority to lead a local sect. Queen Alexia I – after a number of former Otavan Inquisition members aided her in taking the Ferentian throne - has created the Holy Ferenetian Inquisition modelled after the Otavan one, and empowered it to hunt heresy and ward off the encroaching darkness. Tread carefully when pursuing your missives, lest the faithless strap you to the pyre as well."
	whitelist_req = TRUE
