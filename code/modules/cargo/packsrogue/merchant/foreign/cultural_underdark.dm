// Ratwood deviation: AP's stalker falx, stalker dagger, stalker dirk and drowcraft shadowvest do
// not exist in this tree. Their packs are omitted until those items are ported. The bolt quiver
// points at this tree's standard bolt quiver path.
