...
/mob/living/carbon/human/species/wildshape/hag
	...
	wildshape_icon = 'icons/mob/hag_shape.dmi'
...
/datum/species/hag_true_form/regenerate_icons(mob/living/carbon/human/human)
	human.icon = 'icons/mob/hag_shape.dmi'
...
/obj/effect/proc_holder/spell/self/wildshape/hag_true_form
	name = "True Form"
	desc = "I can reveal my true shape to defend the bog from intruders."
	...
	miracle = FALSE
	devotion_cost = 0
	possible_shapes = list(/mob/living/carbon/human/species/wildshape/hag)
