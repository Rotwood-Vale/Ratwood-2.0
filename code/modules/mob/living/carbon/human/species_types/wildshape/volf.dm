/mob/living/carbon/human/species/wildshape/volf //The baseline and tracker of the wildshapes
	...
	wildshape_icon = 'icons/mob/monster/vol.dmi'
...
/datum/species/shapewolf/regenerate_icons(mob/living/carbon/human/H)
	H.icon = 'icons/mob/monster/vol.dmi'
...
/obj/item/weapon/wolf_claw //Like a less defense dagger
	name = "volf claw"
	desc = ""
	item_state = null
	lefthand_file = null
...
/obj/item/weapon/wolf_claw/right
	icon_state = "claw_r"

/obj/item/weapon/wolf_claw/left
	icon_state = "claw_l"

/obj/item/weapon/wolf_claw/Initialize(mapload)
	. = ..()
...
/obj/effect/proc_holder/spell/self/wolfclaws/cast(mob/user = usr)
	..()
	var/obj/item/weapon/wolf_claw/left/l
	var/obj/item/weapon/wolf_claw/right/r

	l = user.get_active_held_item()
	r = user.get_inactive_held_item()
	if(extended)
		if(istype(l, /obj/item/weapon/wolf_claw))
			user.dropItemToGround(l, TRUE)
			qdel(l)
		if(istype(r, /obj/item/weapon/wolf_claw))
