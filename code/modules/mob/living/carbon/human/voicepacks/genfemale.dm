	...
	if(!used)
		switch(soundin)
			...
			if("sexmoanhvy")
				used = list('sound/vo/female/gen/se/sex (1).ogg','sound/vo/female/gen/se/sex (2).ogg','sound/vo/female/gen/se/sex (3).ogg','sound/vo/female/gen/se/sex (4).ogg','sound/vo/female/gen/se/sex (5).ogg','sound/vo/female/gen/se/sex (6).ogg','sound/vo/female/gen/se/sex (7).ogg','sound/vo/female/gen/se/sex (8).ogg')
			if("sexmoangag")
				used = list('modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan1.ogg','modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan2.ogg','modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan3.ogg','modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan4.ogg','modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan5.ogg','modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan6.ogg','modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan7.ogg','modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan8.ogg','modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan9.ogg','modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan10.ogg','modular_rmh/sound/vo/gagged/female/FEMALE_GAGGED_SOFT/gagged_moan11.ogg')
			if("sexmoangag_org")
