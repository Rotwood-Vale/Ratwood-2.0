...
/datum/outfit/job/roguetown/human/species/construct/metal/zizoconstruct/pre_equip(mob/living/carbon/human/H)
	...
	l_hand = /obj/item/weapon/knuckles/bronzeknuckles/zizoconstruct
...
/obj/item/weapon/knuckles/bronzeknuckles/zizoconstruct //I have no unarmed and I must parry. More interesting than defprob and gives construct PC a fun item to loot and use
...
/obj/item/weapon/knuckles/bronzeknuckles/zizoconstruct/pickup(mob/living/user)
