/datum/asset/simple/blackedstone_class_menu_slop_layout
	...
	assets = list(
		"try6.png" = 'icons/misc/try6.png',
		"try6_border.png" = 'icons/misc/try6_border.png',
		"slop_menustyle2.css" = 'html/browser/slop_menustyle2.css',
		"gragstar.gif" = 'icons/misc/gragstar.gif'
	)

/datum/asset/simple/blackedstone_triumph_buy_menu_slop_layout
	keep_local_name = TRUE
	assets = list(
		"try5.png" = 'icons/misc/try5.png',
		"try5_border.png" = 'icons/misc/try5_border.png',
