//Fizzledip's Noxious Brew spell, fills a container with a gross assortment of reagents intended to be used with Aerosolize to create a gross smoke cloud of harmless yet funny reagents
