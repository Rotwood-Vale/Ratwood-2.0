...
/obj/effect/proc_holder/spell/invoked/lesser_heal/cast(list/targets, mob/living/user)
	...
	if(HAS_TRAIT(target, TRAIT_PSYDONITE))
		target.visible_message(span_artery("[target] stirs for a moment, the miracle dissipates."), span_artery("A dull warmth swells in your heart, only to fade as quickly as it arrived."))
