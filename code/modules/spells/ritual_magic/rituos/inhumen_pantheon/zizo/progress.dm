/datum/action/cooldown/spell/ritualis/zizo
	name = "ritualis"
...
/datum/action/cooldown/spell/ritualis/zizo/miracle
...
/datum/action/cooldown/spell/ritualis/zizo/cast(atom/cast_on)
	. = ..()
	if(!ishuman(owner))
		return FALSE
...
/datum/action/cooldown/spell/ritualis/zizo/proc/grant_poke_spell(mob/living/carbon/human/user)
