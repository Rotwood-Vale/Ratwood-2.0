...
/obj/item/reagent_containers/food/snacks/grown/nut
	name = "rocknut"
	desc = desc = "A fragrant nut with stimulating properties, oft-delighted with herbal sugar. Its powder is valuable for fashioning zigs and allspices."
