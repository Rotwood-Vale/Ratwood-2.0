...
/client/proc/returntolobby()
	...
	var/old_advclass_name = H.selected_advclass ? H.selected_advclass : H.advjob
	...
	LAZYREMOVE(GLOB.actors_list[SSjob.get_actors_department(mob_job, H?.mind?.assigned_role)], H.mobid)
