...
// ES deviations: "Citizen of Azuria" -> "Citizen of the Summit"; AP's paper.dmi doesn't exist
...
/obj/item/citizenry_letter/examine(mob/user)
	...
	. += span_info("The letter reads: <i>\"Be it known to all who read this writ, that the bearer, upon claiming this letter, is enrolled as a Citizen of the Summit and raised to the station of Burgher, bearing the protections and obligations attending that rank under the Golden Bull of Kingsfield.\"</i>")
...
/obj/item/citizenry_letter/attack_self(mob/living/carbon/human/user)
	...
	if(HAS_TRAIT(user, TRAIT_RESIDENT))
		to_chat(user, span_warning("I am already a Citizen of the Summit."))
		return
