...
Yeven under the seal of the Crown and the mark of the Guild."}
	revoke_text = "The %RULER% has suspended the Guild Charter of Arms. The mercenaries of the Summit now bear the Crown's common levy in full - and the Guild's tribute to the Pledge ceases until the compact is renewed."
