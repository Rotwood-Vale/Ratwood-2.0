...
/obj/item/rogueweapon/sword/long/exe
	...
	possible_item_intents = list(/datum/intent/sword/cut, /datum/intent/sword/strike)
	gripped_intents = list(/datum/intent/sword/cut, /datum/intent/sword/thrust/exe, /datum/intent/rend)
	icon_state = "exe"
...
/obj/item/rogueweapon/sword/short/messer
	...
	possible_item_intents = list(/datum/intent/sword/cut/sabre, /datum/intent/rend/krieg/short, /datum/intent/axe/chop)	//1.8x rend, similar to partizan
