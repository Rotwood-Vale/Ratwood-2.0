...
/obj/item/reagent_containers/glass/bottle/alchemyjug/attack_self(mob/user)
	var/list/options = list(
		...
		/datum/reagent/consumable/lemonade, //lemonade These are in the proper Alchemy Jug...
		/datum/reagent/consumable/mayonnaise, // mayonaise
		/datum/reagent/consumable/oil/tallow, //oil
		/datum/reagent/consumable/soup/stew/berry_poisoned, //basic poison
	...
	switch(reagent_change)
		...
		if(/datum/reagent/consumable/mayonnaise)
			fill_per_minute = 7.5
		if(/datum/reagent/consumable/oil/tallow)
			fill_per_minute = 3.25
		if(/datum/reagent/consumable/soup/stew/berry_poisoned)
			fill_per_minute = 3.25
