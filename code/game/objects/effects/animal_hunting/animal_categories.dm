...
/datum/hunting_category/low_tier
	...
	animals = list(
		...
		/mob/living/simple_animal/hostile/retaliate/rogue/wolf/bobcat = 8,
		...
		/mob/living/simple_animal/hostile/retaliate/rogue/wolf/raccoon = 10
	)
	preferred_tracks = list(
		/mob/living/simple_animal/hostile/retaliate/rogue/fox = "canine",
		/mob/living/simple_animal/hostile/retaliate/rogue/wolf/bobcat = "small"
	)
