...
/obj/structure/chair/MouseDrop(over_object, src_location, over_location)
	...
	if(over_object == usr && Adjacent(usr))
		...
		if(!usr.canUseTopic(src, BE_CLOSE, ismonkey(usr)))
			return
		usr.visible_message("<span class='notice'>[usr] grabs \the [name].</span>", "<span class='notice'>I grab \the [name].</span>")
...
/obj/item/chair/proc/plant(mob/user)
	...
	user.visible_message("<span class='notice'>[user] rights \the [name].</span>", "<span class='notice'>I right \the [name].</span>")
