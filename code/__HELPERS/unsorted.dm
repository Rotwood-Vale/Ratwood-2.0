...
/proc/has_ghost_chat_protection(atom/target)
	if(!isliving(target))
		return FALSE
	var/mob/living/living_target = target
	return !!living_target.client?.prefs?.ghost_chat_protection
...
//Whether a protected living target should have their chat and actions hidden from this observer.
...
/proc/has_ghost_orbit_protection(atom/target)
	if(!isliving(target))
		return FALSE
	var/mob/living/living_target = target
	return !!living_target.client?.prefs?.ghost_orbit_protection
